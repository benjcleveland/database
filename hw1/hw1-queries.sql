...
/* Q.3 - 48 rows*/
select distinct a.fname, a.lname from actor a, movie m1, movie m2, casts c1, casts c2 where a.id = c1.pid and c1.mid = m1.id  and a.id = c2.pid and c2.mid = m2.id and m1.year < 1900 and m2.year > 2000;
